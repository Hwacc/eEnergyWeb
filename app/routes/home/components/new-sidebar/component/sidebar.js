...
class Sidebar extends Component {
  ...
  onTouchStart(ev) {
    ...
    if (!this.isTouching()) {
      ...
      this.props.onTouching(this.isTouching());
    }
  }
  ...
  onTouchEnd() {
    if (this.isTouching()) {
      ...
      console.log('sidebarWidth = '+this.state.sidebarWidth);
      ...
      if (this.props.open) {
        ...
        dragHandle = (
          <div className="dragHandle"
            ...
            <span style={{color:'white',marginLeft:'5px'}}>&nbsp;&nbsp;&lt;&lt;导航</span>

          </div>);

          const scrollBtnStyle = {...defaultStyles.scrollBtn,...this.props.styles.scrollBtn};
          const scrollDivStyle={...defaultStyles.scrollDiv,...this.props.styles.scrollDiv}
          scrollBtn = (
              <div className="scroll-div" style={scrollDivStyle}>
                <Button style={scrollBtnStyle} onClick={()=>{this.props.scrollBtnUpClick()}}>↑</Button>
                <Button style={scrollBtnStyle} onClick={()=>{this.props.scrollBtnDownClick()}}>↓</Button>
              </div>
          );
      }
    }
    ...
    return (
      <div {...rootProps}>
        ...
        <div className={this.props.contentClassName} style={contentStyle}>
          {dragHandle}
          {this.props.showScrollBtn && scrollBtn}
          {this.props.children}
        </div>
      </div>
    );
...
Sidebar.propTypes = {
  ...
  onSetOpen: PropTypes.func,
    ...
    onTouching:PropTypes.func,
  // Intial sidebar width when page loads
  defaultSidebarWidth: PropTypes.number,
    showScrollBtn :PropTypes.bool,
    scrollBtnUpClick:PropTypes.func,
    scrollBtnDownClick:PropTypes.func,
};
