...
export default class AddModal extends BaseComponent {
    constructor(props){
        ...
        let selectStates = new SelectState([
            ['devicesType',{options:[{name:'空调',value:2},{name:'照明',value:1}],value:props.type,allowEmpty:false,placeholder:'全部'}],
            ['openHour',{options:hourOption,allowEmpty:false,placeholder:'时间'}],
            ['openMinute',{options:minuteOption,allowEmpty:false,placeholder:'时间'}],
            ['offHour',{options:hourOption,allowEmpty:false,placeholder:'时间'}],
            ['offMinute',{options:minuteOption,allowEmpty:false,placeholder:'时间'}],
