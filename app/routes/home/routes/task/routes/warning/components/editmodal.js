...
export default class EditModal extends BaseComponent {
    constructor(props){
        ...
        let selectStates = new SelectState([
            ['devicesType',{options:[{name:'空调开启预警',value:2},{name:'用电量预警',value:0}],value:2,allowEmpty:false,placeholder:'不限'}],
            ['openHour',{options:hourOption,value:0,allowEmpty:false,placeholder:'00时'}],
            ['openMinute',{options:minuteOption,value:0,allowEmpty:false,placeholder:'00分'}],
            ['offHour',{options:hourOption,value:0,allowEmpty:false,placeholder:'00时'}],
            ['offMinute',{options:minuteOption,value:0,allowEmpty:false,placeholder:'00分'}],
        ]);
        this.state={
    ...
    handleData(data){
        ...
        this.handleEditableDataChange('Description',data.Description);
        this.handleEditableDataChange('Alert',data.TimingParam.Alert);
    }
