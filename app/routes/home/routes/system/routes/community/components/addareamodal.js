...
export default class AddModal extends BaseComponent {
    ...
    loadCommunityDevices(c, page) {
        ...
        if(groupType ==1){
            this.communityDeviceRP = apis.device.getDeviceListWithRange((page - 1) * this.pageSize, this.pageSize, '', '', c,'',groupType);
        }else{
    ...
    handleAdd() {
        ...
        this.addGroupRP = apis.group.addGroup(postData);
