    ...
    render(){
        ...
        return(
            <Modal width="350" height="480" show={true}>
                <Modal.Header text="修改用户信息" onClose={()=>{this.props.router.replace('home')}}/>
                ...
                >
                    ...
                    <div className="text-center">
                        <Button size="thin" type="outline" style={{width:100,marginRight:50}} onClick={()=>{this.props.router.replace('home')}}>取消
                        </Button>
