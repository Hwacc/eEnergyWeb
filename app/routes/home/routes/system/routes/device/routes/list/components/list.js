...
class List extends BaseComponent {
    ...
    getCommunityData(){
        ...
        if(list.length>0){
            ...
            this.useListRP = apis.energyInfo.getUseList(val);
            this.useListRP.promise
                .then((res)=> {
                    ...
                    let typeVal = list[0]?list[0].value:null;
    ...
    search(id) {
        ...
        this.deviceRP = apis.device.getDeviceList(selectStates.getSelect('useTypes').value,
